    ...
    <footer className="bg-gray-800 text-white pt-4 mt-12">
      <div className="container mx-auto px-20 text-center">
        ...
        <div className="mb-6 text-center">
          <h2 className="text-3xl font-bold">Eventify</h2>
          <p className="text-sm pt-3 text-gray-300">
            Bringing people together through events, fostering connections, creating memories, <br /> and building communities for a brighter tomorrow.
          </p>
        </div>
